...
library('lme4')
summary(lmer(Acc ~ log(Traffic) + HGV + Urban + Type + log(Length) + Limit + SlopeType + Width + (1 | Tunnel ), data = Accidents))
``` 
...
library('lme4')
summary(lmer(Acc ~ log(Traffic) + HGV + Urban + Type + log(Length) + Limit + SlopeType + Width + (1 | Company), data = Accidents))
``` 
...
library('lme4')
summary(lmer(Acc ~ log(Traffic) + HGV + Urban + Type + log(Length) + Limit + SlopeType + Width + (1 | Year), data = Accidents))
``` 
